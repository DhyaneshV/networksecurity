...
# installed.
TK_PREFIX='/home/dhaynesh/Desktop/Network security /venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/dhaynesh/Desktop/Network security /venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/dhaynesh/Desktop/Network security /venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/dhaynesh/Desktop/Network security /venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/dhaynesh/Desktop/Network security /venv/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/croot/tk_1755243777296/work/tk8.6.15/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/dhaynesh/Desktop/Network security /venv/lib/libtkstub8.6.a'
